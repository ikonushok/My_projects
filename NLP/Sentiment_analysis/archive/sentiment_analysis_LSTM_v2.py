...
# print(f'all_reviews:\t{all_reviews[0][:60]}, {type(reviews)}, {len(reviews)}\n'
#       f'all_words:\t{all_words[:60]}')
...
print(f'66 review_split:\t{all_reviews[0][:60]}, {type(all_reviews)}, {len(all_reviews[0])}')
all_words = all_text.split()
print(f'68 words:\t{all_words[:10]}, {type(all_words)}, {len(all_words)}')
...
print(f'len(encoded_reviews): {len(encoded_reviews)}\t{encoded_reviews[0][:20]}')

###############################################################################
#############################  4. ENCODE LABELS ###############################
###############################################################################
# all_labels = labels.split("\n")
# print(f'len(encoded_reviews): {len(all_labels)}')
...
padded_reviews = pad_text(np.asarray(encoded_reviews), seq_length=200)
...
print(train_x)
train_x[train_x == None] = 0
# train_x = torch.from_numpy(train_x)
print(train_x)
# train_x = torch.Tensor(train_x)
# train_y = torch.Tensor(train_y)
# train_x = train_x.reshape((-1, 1, 3524, 200))
print(train_x.shape, train_y.shape)
